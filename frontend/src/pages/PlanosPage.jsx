                    ...
                    <div style={{
                        ...
                        <div style={{ color: "var(--text-dim)", fontSize: 14, lineHeight: 1.7, margin: "0 0 24px" }}>
                            <p style={{ margin: "0 0 12px" }}>
                                Ao cancelar, o seguinte acontecerá:
                            </p>
                            <ul style={{ margin: 0, padding: "0 0 0 20px", display: "flex", flexDirection: "column", gap: 8 }}>
                                <li>✅ Você <strong style={{ color: "var(--text)" }}>mantém o acesso Pro</strong> até o fim do período já pago</li>
                                <li>❌ Não haverá <strong style={{ color: "var(--text)" }}>novas cobranças</strong> após o cancelamento</li>
                                <li>🔒 Ao expirar, sua conta volta para o <strong style={{ color: "var(--text)" }}>plano Gratuito</strong> (8 arquivos/mês)</li>
                            </ul>
                        </div>
                        ...
                        {isPro ? (
                            <div>
                                ...
                                {msgCancelamento ? (
                                    ...
                                    <button onClick={() => setModalAberto(true)} disabled={cancelando} style={{
