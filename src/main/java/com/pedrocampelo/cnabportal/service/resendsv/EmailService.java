                ...
                <tr><td align="center" style="padding:40px 20px;">
                  <table width="100%%" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%%;">
                    <tr><td align="center" style="padding-bottom:24px;">
                      <div style="display:inline-block;padding:10px 18px;border-radius:999px;border:1px solid rgba(245,158,11,0.30);background:#FFF8E6;color:#B45309;font-size:12px;font-weight:800;letter-spacing:1.2px;text-transform:uppercase;">
                        Whallet · Redefinição de senha
                      </div>
                    </td></tr>
                    <tr><td align="center" style="padding-bottom:24px;">
                      <div style="display:inline-block;width:64px;height:64px;line-height:64px;border-radius:18px;background:linear-gradient(135deg,#F59E0B 0%%,#FCD34D 100%%);color:#111111;text-align:center;font-size:30px;font-weight:900;letter-spacing:-1px;">W</div>
                      <div style="margin-top:12px;color:#111111;font-size:24px;font-weight:800;">Whallet</div>
                    </td></tr>
                    <tr><td>
                      <table width="100%%" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border:1px solid #E7E5E4;border-radius:24px;box-shadow:0 12px 40px rgba(17,17,17,0.06);">
                        <tr><td style="height:6px;background:linear-gradient(135deg,#F59E0B 0%%,#FCD34D 100%%);border-radius:24px 24px 0 0;"></td></tr>
                        <tr><td style="padding:40px 36px 32px 36px;">
                          <div style="color:#111111;font-size:28px;font-weight:900;letter-spacing:-1px;margin:0 0 18px;">Redefinir sua senha</div>
                          <p style="color:#111111;font-size:16px;line-height:1.7;margin:0 0 14px;">Olá, <strong>%s</strong>!</p>
                          <p style="color:#444444;font-size:15px;line-height:1.8;margin:0 0 28px;">
                            Recebemos uma solicitação para redefinir a senha da sua conta. Clique no botão abaixo para criar uma nova senha.
                          </p>
                          <table cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                            <tr><td align="center" style="border-radius:14px;background:linear-gradient(135deg,#F59E0B 0%%,#FCD34D 100%%);box-shadow:0 10px 24px rgba(245,158,11,0.22);">
                              <a href="%s" style="display:inline-block;padding:16px 30px;color:#111111;font-weight:800;font-size:15px;text-decoration:none;white-space:nowrap;">Criar nova senha</a>
                            </td></tr>
                          </table>
                          <p style="color:#666666;font-size:13px;line-height:1.7;margin:0 0 22px;">
                          ...
                          <table width="100%%" cellpadding="0" cellspacing="0">
                            <tr><td style="border-top:1px solid #ECECEC;padding-top:22px;">
                              <p style="color:#787878;font-size:12px;margin:0 0 8px;">Se o botão não funcionar, copie e cole este link:</p>
                              <a href="%s" style="color:#B45309;font-size:12px;word-break:break-all;text-decoration:none;">%s</a>
                            </td></tr>
                          </table>
                        </td></tr>
                      </table>
                    ...
                    <tr><td align="center" style="padding-top:22px;">
                      <p style="color:#8A8A8A;font-size:12px;margin:0;">Whallet &mdash; <a href="https://whallet.com.br" style="color:#8A8A8A;text-decoration:none;">whallet.com.br</a></p>
                    </td></tr>
                  </table>
                </td></tr>
              </table>
